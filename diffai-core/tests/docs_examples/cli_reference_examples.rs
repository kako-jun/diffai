...
fn test_core_json_config() {
    ...
    let has_setting_diff = results.iter().any(|r| format!("{:?}", r).contains("setting"));
...
fn test_core_full_analysis() {
    ...
    let has_complete_diff = results.iter().any(|r| format!("{:?}", r).contains("complete"));
...
fn test_core_json_output() {
    ...
    let has_output_diff = results.iter().any(|r| format!("{:?}", r).contains("output"));
