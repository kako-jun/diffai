...
fn test_core_numpy_array_comparison() {
    ...
    let has_numpy_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("numpy_array"));
...
fn test_core_compressed_numpy_archives() {
    ...
    let has_train_data_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("train_data"));
...
fn test_core_matlab_file_comparison() {
    ...
    let has_results_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("results"));
...
fn test_core_matlab_specific_variables() {
    ...
    let has_experiment_data_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("experiment_data"));
...
fn test_core_matlab_yaml_output() {
    ...
    let has_analysis_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("analysis"));
...
fn test_core_epsilon_tolerance_numerical() {
    ...
    let has_measurement_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("measurement"));
...
fn test_core_matlab_path_filtering() {
    ...
    let has_experimental_data_diff = results
        .iter()
        .any(|r| format!("{:?}", r).contains("experimental_data"));
